...
from knapsack_heuristics import Greedy, DPNumpy
...
if __name__ == '__main__':
   ...
   # ]
    ...
    arr = np.concatenate([np.array([i for i in np.arange(0, 0.5, 0.5/25)]),np.array([i for i in np.arange(0.5, 0.9, 0.4/25)])])
    tour_min = 185382
    tour_max = 429339
    kp_min = 645150
